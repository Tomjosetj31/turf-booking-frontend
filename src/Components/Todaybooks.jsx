      ...
      >
        ...
        <CardContent>
          <Typography variant="body2" color="text.secondary" fontWeight="bold">
           <div style={{color: "white",textAlign:"center"}}>Booked Date   {formattedDate}</div>
          </Typography>
        </CardContent>
        <CardContent>
          <Typography variant="body2" color="text.secondary" fontWeight="bold">
          <div style={{color: "white",textAlign:"center"}}> Start Time   {formattedStartTime} </div>
          </Typography>
        </CardContent>
        <CardContent>
          <Typography variant="body2" color="text.secondary" fontWeight="bold">
          <div style={{color: "white",textAlign:"center"}}> End Time   {formattedEndTime} </div>
          </Typography>
        </CardContent>
      </Card>
    </>
